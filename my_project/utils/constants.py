...
timezones_file_path = os.path.join(settings.BASE_DIR, 'my_project', 'assets', 'timezones.json')
...
currencies_file_path = os.path.join(settings.BASE_DIR, 'my_project', 'assets', 'countries.json')
